...
export const AdminPage: React.FC = () => {
  ...
  const updateBrandingSettings = async () => {
    ...
    try {
      ...
      if (response.ok) {
        setBrandingSettings({ custom_logo_url: logoUrl.trim() || null });
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                  Enter a URL to an image that will replace the default "Lynus RP Hub" branding. Leave empty to use default branding.
                </p>
              ...
              <div className="divide-y divide-gray-200 dark:divide-gray-700">
                {departments.length > 0 ? (
                  departments.map((department) => (
                    <div key={department.id} className="p-6 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-200">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                          <div className="flex-shrink-0">
